      ...
      if (isset($_POST['submit'])) {
        ...
        if (!empty($fname) && !empty($email) && !empty($Any_Injury)) {
          ...
          // Retrieve the user data from MySQL
            $query = mysqli_query($dbc, "SELECT `E-mail` FROM `personal information` WHERE `E-mail`='$email'")or die("chod machi padi hai");
            if(mysqli_num_rows($query)==0) {

              //data is validated ready to enter
                $query = mysqli_query($dbc, "INSERT INTO `personal information`(`Full_Name`, `age`, `E-mail`, `gender`, `country`, `Height`, `Weight`, `Desired_Goal`, `Body_Type`, `Any_Injury`,`Training_Capacity`, `Time_To_Train`,`Plan_Type`) VALUES ('$fname',$age,'$email','$gender','$country','$height','$weight','$desired_goal','$body_type','$Any_Injury','$train_capacity','$time_to_train','$plan_type');")or die("chud gaya tu");
              ...
              $body = 'USER NAME: ' .$fname . '<br> AGE: ' .$age . '<br> E-MAIL: ' .$email. '<br> GENDER: ' .$gender .'<br> COUNRTY: ' .$country. '<br> HEIGHT: ' .$height. '<br> 
               ...
               '<br> DO YOU HAVE ANY INJURY OR ILLNESS: ' .$Any_Injury. '<br> HOW LONG CAN YOU TRAIN IN A DAY: ' .$train_capacity. '<br> MENTION BEST TIME FOR YOU TO TRAIN: ' .$time_to_train. '<br> PLAN TYPE: ' .$plan_type;
                   ...
                   <div class="row row4">
                        ...
                        <div class="col-1-of-2 ">
                                ...
                                <div class="box1">
                                        ...
                                        <div class="row-sub">
                                                <INPUT type="text" name="weight" required id="AGE"></INPUT>
                                        </div>
                  ...
                  <div class="row row6">
                          ...
                          <div class="row row9">
                                        ...
                                        <div class="col-1-of-2 test1">
                                                ...
                                                <div class="col-1-of-2 test2">
                                                        ...
                                                        <div class="box1">
                                                                ...
                                                                <div class="row-sub">
                                                                        <INPUT type="text" name="ttrain" required id="AGE"></INPUT>
                                                                </div>
                                ...
                                <div class="row">
                                                            ...
                                                            <div>
                                                            <button class="button" type="submit"  name="submit" value="SUBMIT AND PAY" >submit</button>
                                                            </div>
