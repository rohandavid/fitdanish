          ...
          // Retrieve the user data from MySQL
            ...
            if(mysqli_num_rows($query)==0) {
              ...
              //data is validated ready to enter
                $query = mysqli_query($dbc, "INSERT INTO `personal information`(`Full_Name`, `age`, `E-mail`, `gender`, `country`, `Height`, `Weight`, `Desired_Goal`, `Body_Type`, `Any_Injury`, `Alergies`,`Can_Use_Supplements`, `Plan_Type`, `time_entered`) VALUES ('$fname','$age','$email','$gender','$country','$height','$weight','$desired_goal','$body_type','$Any_Injury','$Alergies','$usplus','$plan_type',NOW())")or die("Chud gaya tu");
              ...
              $body = 'USER NAME: ' .$fname . '<br> AGE: ' .$age . '<br> E-MAIL: ' .$email. '<br> GENDER: ' .$gender .'<br> COUNRTY: ' .$country. '<br> HEIGHT: ' .$height. '<br> 
               ...
               '<br> DO YOU WISH TO USE SUPPLEMENTS: ' .$usupls. '<br> PLAN TYPE: ' .$plan_type;
